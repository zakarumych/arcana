...
impl AshFrom<CompareFunction> for ash::vk::CompareOp {
    #[inline(always)]
    fn ash_from(compare: CompareFunction) -> Self {
        match compare {
            CompareFunction::Never => ash::vk::CompareOp::NEVER,
            CompareFunction::Less => ash::vk::CompareOp::LESS,
            CompareFunction::Equal => ash::vk::CompareOp::EQUAL,
            CompareFunction::LessEqual => ash::vk::CompareOp::LESS_OR_EQUAL,
            CompareFunction::Greater => ash::vk::CompareOp::GREATER,
            CompareFunction::NotEqual => ash::vk::CompareOp::NOT_EQUAL,
            CompareFunction::GreaterEqual => ash::vk::CompareOp::GREATER_OR_EQUAL,
            CompareFunction::Always => ash::vk::CompareOp::ALWAYS,
        }
    }
}

impl AshFrom<BlendFactor> for ash::vk::BlendFactor {
    #[inline(always)]
    fn ash_from(factor: BlendFactor) -> Self {
        match factor {
            ...
            BlendFactor::SrcAlphaSaturated => ash::vk::BlendFactor::SRC_ALPHA_SATURATE,
            BlendFactor::BlendColor => ash::vk::BlendFactor::CONSTANT_COLOR,
            BlendFactor::OneMinusBlendColor => ash::vk::BlendFactor::ONE_MINUS_CONSTANT_COLOR,
        }
    }
}

impl AshFrom<BlendOp> for ash::vk::BlendOp {
    #[inline(always)]
...
impl AshFrom<WriteMask> for ash::vk::ColorComponentFlags {
    #[inline(always)]
